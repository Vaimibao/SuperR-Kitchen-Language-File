...
startup_srkuser_error4 = "退出厨房再运行，再输入一遍呗，这个用户名不是gitlab"
startup_srkuser_error5 = "的，是SpuerR最新厨房让你注册新的账户名，不懂去看新帖."
startup_srkuser_noauth = "此电脑未被授权运行厨房."
startup_srkuser_q = "亲，这是您的用户名吗?  y/n"
startup_srkpass_q = "亲，要不要保存密码呢?  y/n"
startup_error = "初始化运行有点问题. 重新安装一下吧."
...
donate_bdisplay = "你想要你的ROM在刷机时twrp显示什么?"
...
root_supersu_q = "SuperSU 已经不更新了. 你确定添加它码?  y/n"
...
menu_zip_compression = "ROM zip压缩等级"
menu_zip_compression2 = "输入所需的zip压缩等级 "
...
metasize_s = "短"
metasize_l = "长"
metasize_q = "你想设定多长的set_metadata updater-script ?"
...
img_dir_open = "确保您的system文件夹没有被文件管理器打开后再试下"
img_dir_open2 = "..."
