# -*- coding: utf-8 -*-
# Translation by xiyan at 2020.06.05
# Sina Weibo : https://weibo.com/xiyan1996
# Main Menu
title_main = "主菜单"
title_choose = "选择项目:"
title_delete = "删除项目:"
...
startup_copy_extract = "首先把你的ROM文件放到项目文件夹里"
startup_copy_extract2 = "然后你按下4就可以进行解压以及后续操作"
startup_title_no_rom = "没有ROM文件"
startup_no_projects = "当前没有项目."
startup_prep_updater_script = "准备updater-script ..."
startup_no_rom = "文件夹里没有ROM呀!"
startup_srkuser = "输入SuperR他服务器注册的新账号用户名 (不是email地址):"
startup_srkuser_pass = "请输入账户密码: "
startup_srkuser_error = "不要输入email地址,是用户名."
startup_srkuser_error2 = " <--这个名字没在SuperR数据库里，或者是"
startup_srkuser_error3 = "密码输错了. 请再想想你的用户名和密码"
startup_srkuser_error4 = "试试:退出厨房再运行，再输入一遍."
startup_srkuser_error5 = "就是这个网址输入的用户名:https://sr-code.com/down/."
startup_srkuser_noauth = "此电脑未被授权,无法运行厨房."
startup_srkuser_q = "确认你的用户名?  y/n"
startup_srkpass_q = "是否保存密码?  y/n"
startup_error = "初始化运行有点问题. 重新安装一下吧.(创建新空文件夹再运行)"
startup_checksum = "以下文件校验码不匹配:"
startup_environ_error = "此环境下无法运行厨房"
startup_vdisk_error = "厨房无法在Live模式下的虚拟磁盘上运行"
startup_remdisk_error = "厨房无法在Live模式下在可移动磁盘上运行"

# Build
menu_build_zip = "创建ROM Zip文件"
menu_sys_img = "创建img文件"
menu_sign = "签名目录里已有zip"
donate_menu_zipalign = "Zipalign apk文件"
donate_menu_custom_id = "自定义ro.build.display.id"
menu_custom_zip = "自定义压缩菜单"
build_selinux_error = "你的内核不支持selinux, 或者是厨房没在"
build_selinux_error2 = "boot里找到所需的文件.如果你能确定你的设备的"
build_selinux_error3 = "boot镜像支持selinux, 你可以复制内核的ramdisk文件夹里"
build_selinux_error4 = "file_contexts到项目00_project_files目录里,然后你就可以继续了."
build_selinux_error5 = ""
build_selinux_error6 = "现在,你将要选择set_perm 或 raw_img."
build_patient = "这要花费一点时间. 请耐心等待..."
build_prep_img = "正在准备创建img文件 ..."
build_check_ziplog = "出现错误. 请查看zip.log文件寻找错误."
build_prep_sys_img = "正在创建img文件..."
build_img_error = "创建img过程中出现错误."
build_img_which = "你要创建哪种img?"
build_img_nocon = "厨房没找到 file_contexts 这个文件. 确保你的"
build_img_nocon2 = "boot.img 是放在现在的ROM项目文件夹里, 或者"
build_img_nocon3 = "你复制内核解压后文件夹里file_contexts到"
build_img_nocon4 = "00_project_files这个文件夹里面,然后重试."
build_no_zip = "没有找到可签名的zip包."
build_no_boot_q = "你的的ROM没有boot.img或kernel.img/ramdisk.img."
build_no_boot_q2 = "是否继续?  y/n"
build_cho_zip = "选择zip进行签名:"
build_man_img_size = "是否使用以下显示的大小数值?  y/n"
zipalign_q = "打包ROM之前需要zipalign吗?  y/n  "
zipalign = "Zipalign中..."
zipalign_frame_q = "你需要对system/framework文件夹中的apk执行zipalign吗?  y/n "
zipalign_complete = "Zipalign完成"
donate_bdisplay = "你想要你的ROM在刷机时Recovery显示什么信息?"

# Custom zip
title_cho_cust_zip = "选择创建自定义zip:"
cust_deldir_q = "您希望创建好zip后删除zip所用到的所有文件(夹)?"
cust_deldir_q2 = "就是项目目录里的system文件夹、boot.img等这些  y/n"
cust_meta_prep = "准备META-INF 文件夹..."
cust_not_exist = "你要压缩的文件夹不存在."
cust_dir_info = "请确保你至少拥有以下其中一项 "
...
bloat_cust_info = "将内容添加到以下文件之一以使用此功能"
...
# Root
title_cho_root_zip = "选择需要Root的Zip:"
menu_root_method = "要哪种ROOT方式呢?"
menu_ss_method = "要安装哪种SuperSU呢?"
menu_supersucho = "还是由SuperSU决定"
...
busybox_q = "需要添加Busybox吗?  y/n  "
root_sud_add_q = "需要添加su.d吗?  y/n  "
root_sud_rem_q = "需要移除su.d吗?  y/n  "
...
general_cont_anyway_q = "仍要继续?  y/n  "
general_extracting = "提取"
general_create = "已创建在"
general_build = "正创建在"
no_python = "使用此功能需安装 Python3.5+ (曦颜提醒：如果还出问题，切换默认系统PY版本后重试)."
...
menu_deopatch = "给Oreo deodex化打sepolicy补丁"
menu_deopatch_fail = "打补丁失败, 可能sepolicy 已经patch了."
menu_deopatch_sepol = "sepolicy不存在"
menu_deopatch_add = "Oreo deodex的sepolicy 已经patch了"
menu_unpack = "解包"
...
boot_packed_d = " 已打包"
boot_no_img = "没有boot.img 或者recovery.img "
...
auth_reset2 = "首次重新启动需要Internet访问."
auth_max_days = "最长离线授权天数: "
auth_expired = "离线授权会话已到期."
support_create = "创建support.zip中 ..."
...
heapsize_reset = "返回默认heapsize"
heapsize_num_error = "您必须输入一个数字(单位MB (例如: 1024))"
heapsize_error = "Heapsize必须等于或小于物理RAM的大小."
heapsize_error2 = ""
physical_ram = "物理RAM: "
heapsize_auto = "默认"
ask_b = "每次转换update-binary脚本时询问"
ask_s = "每次询问"
always_b = "总是转换到update-binary脚本"
always_s = "总是转换"
never_b = "从不转换到update-binary脚本"
never_s = "从不转换"
metasize = "简短/长的 set_metadata updater-script"
metasize_s = "短"
metasize_l = "长"
...
perm_check_symlinks = "检查symlinks中 ..."
perm_set_metadata_error = "这个ROM不是 KitKat或更高"
...
deodex_copy_frame_prop2 = "build.prop从您的ROM里复制"
...
deodex_disclaimer = "Deodex ROM后可能无法刷入刷机包. "
deodex_disclaimer2 = "你可能会收到错误,而且手机不一定开机"
deodex_disclaimer3 = "（这我遇到过的问题）.你最好确保自己知道如何解决."
deodex_disclaimer4 = "请不要因为这个问题找我问. 谢谢 :)"
...
deodex_config_arch = "设置下手机的架构arch."
deodex_config_arch2 = "提示(架构arch具体为):"
...
deodex_del_meta_inf = "从apk的删除META-INF中..."
...
# Extract
extract_title = "提取菜单"
extract_no_files_message = "1) 首先添加一个ROM的 zip, tar/boot.img, system.img"
extract_no_files_message2 = "或boot.img或win/boot.win,然后选择该选项.."
...
extract_detect_part2 = "如果您遇到问题，请尝试更改USB模式"
extract_detect_part3 = "状态栏下拉连接模式改为媒体模式 (MTP)"
extract_pull_error = "出错了.可能是没有权限从设备里出img文件"
extract_pull_error2 = "(#^.^#)."
extract_pulling = "拉取中 "
extract_prep = "正在准备提取 ..."
...
extract_cache_fail = "在cache.img中没有csc.zip文件"
...
extract_beta4 = "您可以将授权方式更改为set_metadata或set_perm来避免使用"
extract_beta5 = ""
...
byname_detect = "从recovery.img里检测by-name相关代码"
...
update_cred_fail = "您的付费用户认证未成功,因为在数据库中未找到你的信息."
update_cred_fail2 = "你可以在你付费后并且注册完成后下载最新的厨房zip文件."
update_cred_fail3 = ""
...
# New Project
new_q = "请输入新项目名称(输入后在厨房目录生成文件夹, 例如: superr_您输入的内容):"
...
donate_plugin_reinstall_q = "无法检查更新，因为它是在更新系统之前安装的."
...
img_flash_failB3 = "或着在zip包创建之后手动插入分区信息"
img_sparse_q = "想创建什么类型的img?"

# Language
reset_language = "语言设定已重置. 请现在重启厨房"
lang_added = "语言文件已更新."
lang_translate = "请校对."
...
tools_dl_device_failed = "无法下载一些device数据库."
tools_dl_device_failed2 = "稍后使用Misc Tools升级设备数据库到最新的版本"
tools_dl_device_failed3 = ""
wintools_dl = "(大概要下载 17MB 大小文件 )"
lintools_dl = "(大概要下载 24MB 大小文件)"
tools_need = "要安装厨房所需依赖才能正常使用."
